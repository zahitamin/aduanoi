...
if (isset($_GET['no_matrik'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $_GET['no_matrik'] : addslashes($_GET['no_matrik']);
}
mysql_select_db($database_localhost, $localhost);
$query_Recordset1 = sprintf("SELECT * FROM aduan WHERE no_matrik = '%s'", $colname_Recordset1);
$Recordset1 = mysql_query($query_Recordset1, $localhost) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

$colname_maklumatlaporan = "-1";
if (isset($_GET['no_matrik'])) {
  $colname_maklumatlaporan = (get_magic_quotes_gpc()) ? $_GET['no_matrik'] : addslashes($_GET['no_matrik']);
}
mysql_select_db($database_localhost, $localhost);
$query_maklumatlaporan = sprintf("SELECT * FROM aduan WHERE no_matrik = '%s'", $colname_maklumatlaporan);
$maklumatlaporan = mysql_query($query_maklumatlaporan, $localhost) or die(mysql_error());
$row_maklumatlaporan = mysql_fetch_assoc($maklumatlaporan);
$totalRows_maklumatlaporan = mysql_num_rows($maklumatlaporan);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
mysql_free_result($maklumatlaporan);
?>
